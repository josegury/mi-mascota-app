...
export class RegistroPage implements OnInit {
  ...
  aceptado_aviso_legal: boolean = false;
  ...
  ngOnInit() {
    this.validations_form = this.formBuilder.group({
      ...
      aviso_legal: new FormControl(false, Validators.compose([
  ...
  async tryRegister(value){
      ...
      .then(res => {
        this.errorMessage = "";
        this.usuarioService.addUsuario(value.email);
  ...
  async verAvisoLegal(value){
    if(this.validations_form.valid){

      let alert = await this.alertCtrl.create({
        header:'Politica de privacidad',
        message: this.getPoliticaPrivacidad(),
        buttons: [
          {
            text: 'Cancelar',
            role: 'cancel',
